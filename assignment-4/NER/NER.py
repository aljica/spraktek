...
class NER(object):
    ...
    def prev_and_current_token_capitalized(self):
        return self.current_token != None and self.last_token != None and self.current_token.istitle() and self.last_token.istitle()
    ...
    def __init__(self, training_file, test_file, model_file, stochastic_gradient_descent,
        ...
        self.features = [
            ...
            #NER.FeatureFunction(self.prev_and_current_token_capitalized),
        ]
